...
export default function People() {
  ...
  return (
    <main className="w-full min-h-[100vh] mt-10">
      <div className="max-w-[1200px] w-full mx-auto grid grid-cols-4 gap-10 ">
        {popularPeople?.map((people) => {
          return (
            <div key={people.id} className="w-full flex justify-center items-center flex-col">
              <div>
                <img className="w-full h-full" src={cast_img + people.profile_path} alt="" />
              </div>
              <div>
